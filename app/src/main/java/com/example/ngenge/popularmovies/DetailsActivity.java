        ...
        favoriteButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(movieViewModel.isMovieFavorited(movieId))
                {
                    ...
                    Toast.makeText(DetailsActivity.this,"Removed from favorites",Toast.LENGTH_LONG)
                            .show();
                    favoriteButton.setBackgroundColor(Color.LTGRAY);
                    ...
                    favoriteButton.setBackgroundColor(Color.YELLOW);
                    Toast.makeText(DetailsActivity.this,"Inserted into favorites",Toast.LENGTH_LONG)
                            .show();
                }
